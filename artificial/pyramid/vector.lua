...
function vector_length_squared(a) return a.x*a.x+a.y*a.y end
...
function vector_add(a,b,r) return vector_set(r,a.x+b.x,a.y+b.y) end
function vector_subtract(a,b,r) return vector_set(r,a.x-b.x,a.y-b.y) end
function vector_multiply(a,s,r) return vector_set(r,a.x*s,a.y*s) end
function vector_dot(a,b) return a.x*b.x+a.y*b.y end
...
vector.transformNormal=function(a,m) return vector_transform_normal(a,m,vector.new()) end
...
vector.new=function(vx,y)
  ...
  _.lengthSquared=function() return vector_length_squared(_) end
